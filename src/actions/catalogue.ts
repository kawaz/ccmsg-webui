...
export const ACTIONS: readonly Action[] = [
  ...
  // 本文をどちらで読むか。markdown は原文とプレビュー、ブラウザが素で描ける物は
  // 文と閲覧 site の窓 (DR-0005 §2.2)。切り替える所が 1 つなのは、読み手にとって
  // 「この文書の別の見え方」が 1 つの操作だから。
  { id: "files.view", title: "本文の見え方を切り替える (文 ⇄ プレビュー)" },
