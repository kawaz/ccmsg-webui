...
人が選ぶ色相は 2 つだけ — 自分とユーザ。それ以外の相手の色相は `src/member.ts` が
配る。意味色 4 つと固定の 2 人の前後 15 度を避け、相手の名前から作った希望が空いて
いればそこ、埋まっていればいちばん広い空きの真ん中へ置き、**一度置いた色相は動かない**
(増えるたびに色が動くと、色で人を覚えられない)。名乗りが段 12、罫が段 8 なのは、
