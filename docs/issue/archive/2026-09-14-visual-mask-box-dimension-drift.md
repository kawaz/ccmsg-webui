...
pending_entered:
discarded_entered:
resolved_entered: 2026-09-15T13:05:36+09:00
discard_reason:
pending_reason:
close_reason: ["done: v1.0.1 で根本原因(等幅でない数字フォント)を特定、時刻を持つ箱(connection-who/footer/hit-when/status-elapsed)の幅を test/visual/screenshot.css で固定。3 回連続 pass"]
blocked_by:
origin: 自リポ TODO
---
