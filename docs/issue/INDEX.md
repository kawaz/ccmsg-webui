...
|---|---|---|---|---|
| 2026-09-16 | bug | open | [terminals-visual-pid-elapsed-band-diff](./2026-09-16-terminals-visual-pid-elapsed-band-diff.md) | terminals visual test が pid/経過時刻の帯で閾値超え diff を出す |
