...
| 2026-09-19 | bug | open | [visual-baseline-order-flaky](./2026-09-19-visual-baseline-order-flaky.md) | 基準撮り直し後、just visual が顔ぶれ違う失敗を出す (真因 3 つ判明・対処済み、残り 1 回は別 issue) |
