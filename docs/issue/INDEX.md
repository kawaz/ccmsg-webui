...
| 2026-09-17 | bug | open | [localstorage-keys-namespaced-by-mount](./2026-09-17-localstorage-keys-namespaced-by-mount.md) | localStorage キーが固定で、同一 origin の別 path に 2 つ mount すると衝突する |
